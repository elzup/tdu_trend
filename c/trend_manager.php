...
class TrendManager
{
    ...
    private function manageReplay0(Tweet $tw)
    {
    ...
    private function manageReplay1(Tweet $tw)
    {
    ...
    private function manageReplay2(Tweet $tw)
    {
    ...
    public function manageReplay3(Tweet $tw, $debug = false)
    {
